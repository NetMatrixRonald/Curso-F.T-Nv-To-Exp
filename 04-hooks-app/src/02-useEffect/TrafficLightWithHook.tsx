import { useTrafficHook } from "./hook/useTrafficLight";
...
export const TrafficLightWithHook = () => {
    ...
    const {countdown, percentage, redLight, yellowLight, greenLight} = useTrafficHook()
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800 flex items-center justify-center p-4">
        <div className="flex flex-col items-center space-y-8">
            ...
            <div className="w-64 bg-gray-700 rounded-full h-2">
                <div className="bg-blue-500 h-2 rounded-full transition-all duration-1000" style={{ width: `${percentage}% `}}></div>
            </div>
